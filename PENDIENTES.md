...
- **PROP-3 / TERR-**: El terreno registrado como PROP-3 en Notion tiene prefijo incorrecto según la regla v0.5 (que usa TERR-). El dueño debe decidir si renumerar el registro existente. Mientras tanto, al auto-generar el código de un nuevo terreno se usará el prefijo TERR- sin tocar PROP-3.
...
- **"Usar mi ubicación" devolvió coordenadas en India**: Posiblemente por IP/proxy de la red durante la prueba. Verificar comportamiento y precisión en dispositivos móviles reales antes de lanzar a producción.

- **"Elegir en el mapa" no centra en México**: El selector de mapa no centra por defecto en Cuernavaca/México. Ajustar centrado inicial a coordenadas de referencia (18.9261, -99.2308) en una fase posterior (Fase 8 · pulido).

---

## Mejoras futuras (evaluación)

- **Catálogo de Fuentes**: Revisar y actualizar las opciones del select. Las fuentes actuales no reflejan todas las vías reales de captación del equipo.
